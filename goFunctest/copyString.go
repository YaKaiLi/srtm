...
func main() {
	...
	logrus.Infof("======================================")
	logrus.Infof("uintptrDiffidListString:", uintptrDiffidListString)
	logrus.Infof("uintptrDiffidListStringLen:", uintptrDiffidListStringLen)
	logrus.Infof("diffIdDeep:", diffIdDeep)
	logrus.Infof("======================================")
	//执行系统调用
